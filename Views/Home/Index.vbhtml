...
<head>
    ...
    <title>Home Page - PRG522Summative</title>
    <!-- Favicon -->
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="top-contact">
                                ...
                                <div class="single-contact"><i class="fa fa-envelope-open"></i>Email: info@ctcareer.co.za</div>
                            ...
                            <div class="topbar-right">
                                ...
                                <div class="button">
                                    <form action="/Account/Login" method="get">
                                        <button class="bizwheel-btn">LogIn</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="nav-inner">
                                                        <div class="menu-home-menu-container">
                                                            ...
                                                            <ul id="nav" class="nav main-menu menu navbar-nav">
                                                                ...
                                                                <li>
                                                                    <form action="/" method="post"><a href="/">Home</a></form>
                                                                </li>
                                                                <li>
                                                                    <form action="/Home/Services" method="post"><a href="/Home/Services">Services</a></form>
                                                                </li>
                                                                <li>
                                                                    <form action="/Home/Portfolio" method="post"><a href="/Home/Portfolio">Portfolio</a></form>
                                                                </li>
                                                                <li>
                                                                    <form action="/Home/About" method="post"><a href="/Home/About">About</a></form>
                                                                </li>
                                                                <li>
                                                                    <form action="/Home/Contact" method="post"><a href="/Home/Contact">Contact</a></form>
                                                                </li>
                                                            </ul>
                                                            <!--/ End Naviagiton -->
                                                        </div>
            ...
            <div class="sidebar-popup">
                ...
                <div class="single-content">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <form action="/Home/Services" method="post">
                                <a>Services</a>
                            </form>
                        </li>
                        <li>
                            <form action="/Home/Portfolio" method="post">
                                <a>Portifolio</a>
                            </form>
                        </li>
                        <li>
                                        ...
                                        <div class="hero-text">
                                            ...
                                            <div class="button">
                                                <form action="/Account/Register" method="get">
                                                    <button class="bizwheel-btn theme-1 effect">Work with us</button>
                                                </form>
                                            </div>
                                            <div class="button">
                                                <form action="/Home/Portfolio" method="get">
                                                    <button class="bizwheel-btn theme-2 effect">View Our Portfolio</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="button">
                                <form action="/Home/Portfolio" method="get">
                                    <button class="bizwheel-btn theme-2 effect">Our Portfolio</button>
                                </form>
                            </div>
                        </div>
                    </div>
                                ...
                                <div id="portfolio-item" class="portfolio-item-active">
                                    ...
                                    <div class="cbp-item seo consulting">
                                        ...
                                        <div class="single-portfolio">
                                            ...
                                            <div class="portfolio-content">
                                                <h4><a href="">Creative Marketing</a></h4>
                                                <p>Seo, Consulting</p>
                                            </div>
                                        </div>
                                        <!--/ End Single Portfolio -->
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <div class="single-widget footer-about widget">
                                ...
                                <div class="button">
                                    <form action="/Home/About" method="post">
                                        <button class="bizwheel-btn">About Us</button>
                                    </form>
                                </div>
                            </div>
                            <!--/ End Footer About -->
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            ...
                            <div class="single-widget footer-news widget">
                                ...
                                <div class="single-f-news">
                                    ...
                                    <div class="content">
                                        <p class="post-meta"><time class="post-date"><i class="fa fa-clock-o"></i>August 27, 2021</time></p>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <div class="single-widget footer_contact widget">
                                ...
                                <ul class="address-widget-list">
                                    ...
                                    <li class="footer-mobile-number"><i class="fa fa-envelope"></i>info@ctucareer.co.za</li>
                                    <li class="footer-mobile-number"><i class="fa fa-map-marker"></i>1st Floor, Pretty Suites Office Block</li>
                                </ul>
                            </div>
                            <!--/ End Footer Contact -->
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="copyright-content">
                                <!-- Copyright Text -->
                                <p>&copy; Copyright PRGSummative - Paulo NGOVE</p>
                            </div>
                        </div>
                    </div>
                </div>
